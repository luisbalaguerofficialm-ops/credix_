    ...
    <div className="flex flex-col gap-12 md:gap-20 mb-5 items-center text-center min-h-screen p-4 md:px-8 bg-gray-50">
      ...
      <section className="bg-white rounded-lg border w-full h-55 max-w-6xl shadow border-gray-200 p-8 md:p-10 mb-32 md:mb-40 flex flex-col items-center justify-center text-center mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-6 w-full">
          {/* Search Input */}
          <div className="flex items-center border border-gray-300 rounded-md px-4 w-full md:w-[400px] h-11">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        {/* Export Buttons */}
        <div className="flex flex-wrap justify-start gap-4 mt-10 md:mt-12 mb-8 w-full md:w-[400px]">
          <button className="flex items-center justify-center w-[180px] h-10 gap-3 border border-gray-300 px-4 py-2 rounded-md hover:bg-gray-100 transition">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="w-4 h-4"
              fill="none"
      ...
      <section className="bg-white border border-gray-300 rounded-lg w-full max-w-6xl overflow-x-auto shadow">
        ...
        <div className="w-full min-w-[750px] sm:min-w-full overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-200">
